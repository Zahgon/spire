...
func (c *Catalog) Reconfigure(ctx context.Context) { _ = "STUB: not implemented"; return }

func (c *Catalog) Close() error { _ = "STUB: not implemented"; return nil }
...
func (c pluginCloser) Close() error { _ = "STUB: not implemented"; return nil }
