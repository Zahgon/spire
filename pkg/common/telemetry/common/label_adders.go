...
func AddAttestorType(cc *telemetry.CallCounter, aType string) { _ = "STUB: not implemented"; return }

// AddCallerID add the CallerID label to the given counter
// from the given ID. If ID is empty, assign "unknown".
func AddCallerID(cc *telemetry.CallCounter, id string) { _ = "STUB: not implemented"; return }
